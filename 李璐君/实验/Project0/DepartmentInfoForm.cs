...
namespace Project0
{
    public partial class DepartmentInfoForm : Form
    {
        ...
        public void count() 
        { var doctorCounts = from dep in database.Departments from doc in dep.Doctors
                             group doc by doc.Dept_id into d 
                             select new { Department_ID = d.Key,
                                 DepartmentName = d.First().Departments.Dept_name, NumberOfDoctors = d.Count() }; dataGridView1.DataSource = doctorCounts; }
